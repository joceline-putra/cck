                ...
                <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                  <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12">
                      ...
                      <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-right">
                        <div class="pull-right">
                          <button id="btn_balance_deposit" class="btn btn-success btn-small" type="button"
                            style="display: inline;">
                            <i class="fas fa-sign-in-alt"></i>
                            Deposit Poin
                          </button>                            
                          <button id="btn_balance_end" class="btn btn-primary btn-small" type="button"
                            style="display: inline;">
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side" style="padding-top:8px;">
                      ...
                      <div class="col-lg-6 col-md-9 col-xs-12 col-sm-12 form-group padding-remove-right prs-15">
                        <label class="form-label">Cari</label>
                        <input id="filter_search" name="filter_search" type="text" value="" class="form-control" placeholder="Pencarian" />
                      </div>                                 
                      <div class="col-lg-2 col-md-3 col-xs-12 col-sm-12 form-group">
