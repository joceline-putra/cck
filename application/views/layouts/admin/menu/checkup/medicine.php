                      ...
                      <div class="grid-body">
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-12 padding-remove-right">
                          <div class="pull-right">
                            <button id="btn-help" onClick="" class="btn btn-default btn-small" type="button"
                              style="display: none;">
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                  ...
                                  <div class="col-md-12 col-xs-6 col-sm-12 padding-remove-side">
                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side">
                                      <div class="form-group">
                                        <label class="form-label">Kepada Pasien *</label>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 padding-remove-right">
                                  ...
                                  <div class="col-md-12 col-xs-6 col-sm-12 padding-remove-side">
                                    <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-left">
                                      <div class="form-group">
                                        <label class="form-label">Nomor Referensi (jika ada)</label>
                    ...
                    <div class="grid-body">
                        ...
                        <form id="form-trans-item" name="form-trans-item" method="" action="">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12 padding-remove-side">
                            ...
                            <div class="col-md-5 col-xs-12 col-sm-12 padding-remove-side">
                              <div class="form-group">
                                <label>Produk (Barang, Obat, Jasa, Alat Kesehatan, Tindakan)*</label>
                      ...
                      <div class="col-md-12 col-xs-12 col-sm-12 padding-remove-side scroll">
                        <table id="table-item" class="table table-striped" data-limit-start="0" data-limit-end="10">
                          <thead>
                            <tr>
                              <th>Produk (Barang, Obat, Jasa, Alat Kesehatan) </th>
