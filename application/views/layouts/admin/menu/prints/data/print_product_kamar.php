...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div id="print-paper" class="col-md-12" style="">
            <div class="col-md-12 col-xs-12">
                ...
                <div class="col-md-10 col-sm-10 col-xs-10" style="padding-left:0px;">
                    ...
                    <?php 
                        ...
                        if(!empty($branch)){
                            echo '<br>Cabang : ' . $branch;                
                        }else{
                            echo '<br>Cabang : Semua';
                        }
                    ...
                    <table class="table table-bordered table-hover" style="100%;">
                        <thead>
                            <tr>
                                ...
                                <td style="text-align:right;">Harga 0</td>
                                <td style="text-align:right;">Harga 1</td>    
                                <td style="text-align:right;">Harga 2</td>
                                <td style="text-align:right;">Harga 3</td>
                                <td style="text-align:right;">Harga 4</td>
                                <td style="text-align:right;">Harga 5</td>                                                                                                                                    
                            </tr>
                        </thead>
                    <tbody>
                        <?php 
                        ...
                        <tr data-trans-id="<?php echo $v['product_id'];?>">
                            ...
                            <td style="text-align:right;"><?php echo $v['branch_name'];?></td> 
                            <!-- <td style="text-align:left;"><?php #echo $v['product_unit'];?></td>  -->
                            <td style="text-align:left;"><?php echo $v['ref_name'];?></td> 
                            ...
                            <td style="text-align:right;"><?php echo number_format($v['ref_price_0']);?></td>
                            <td style="text-align:right;"><?php echo number_format($v['ref_price_1']); ?></td>
                            <td style="text-align:right;"><?php echo number_format($v['ref_price_2']); ?></td>
                            <td style="text-align:right;"><?php echo number_format($v['ref_price_3']); ?></td>
                            <td style="text-align:right;"><?php echo number_format($v['ref_price_4']); ?></td>
                            <td style="text-align:right;"><?php echo number_format($v['ref_price_5']); ?></td>                                                                                                                    
                            <?php 
