    ...
    <div class="container-fluid">
        <div class="col-xs-8 agile-leftmk">
            ...
            <form action="#" method="post">
                <input type="email" placeholder="E-mail" id="subscribe_email" name="email" required="">
        ...
        <div class="col-xs-4 w3l-rightmk">
            <img src="<?php echo $template; ?>images/tab3.png" alt=" ">
        </div>
    ...
    <div class="container">
        ...
        <div class="footer-info w3-agileits-info">
            ...
            <div class="col-sm-2 footer-grids  w3l-socialmk">
                ...
                <div class="agileits_app-devices">
                    ...
                    <a href="#">
                        <img src="<?php echo $template; ?>images/1.png" alt="">
                    </a>
                    <a href="#">
                        <img src="<?php echo $template; ?>images/2.png" alt="">
                    </a>
                    <div class="clearfix"> </div>
                </div>
            </div>
        ...
        <div class="agile-sometext">
            ...
            <div class="sub-some child-momu">
                ...
                <ul>
                    <li>
                        <img src="<?php echo $template; ?>images/pay2.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay5.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay1.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay4.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay6.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay3.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay7.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay8.png" alt="">
                    </li>
                    <li>
                        <img src="<?php echo $template; ?>images/pay9.png" alt="">
                    </li>
                </ul>
            </div>
            <!-- //payment -->
...
<!-- //footer -->
<!-- copyright -->
<div class="copy-right" style="background-color: #7b0401!important;">
    <div class="container">
